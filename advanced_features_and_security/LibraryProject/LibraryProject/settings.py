...
INSTALLED_APPS += ['csp']
CSP_DEFAULT_SRC = ("'self'",)  # Restrict loading content to the same origin
...
SECRET_KEY = 'django-insecure-5(4*5&=h6ah1&mecv-_hv4pr7*)6r%1v9z*vw^uv$k6s@!1_u+'
...
MIDDLEWARE = [
    ...
    'path.to.ContentSecurityPolicyMiddleware',
]
